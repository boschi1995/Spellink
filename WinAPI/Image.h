...
public:
	...
	inline bool isFrame(void) { return _imageInfo->isFrame; }

	inline void isClipping(bool state) { _imageInfo->isClipping = state; }
	inline bool isClipping() { return _imageInfo->isClipping; }

	inline void setClippingX(int set) { _imageInfo->ClippingX = set; }
	inline void setClippingY(int set) { _imageInfo->ClippingY = set; }
	inline void setClippingW(int set) { _imageInfo->ClippingW = set; }
	inline void setClippingH(int set) { _imageInfo->ClippingH = set; }

	inline int getClippingX() { return _imageInfo->ClippingX; }
	inline int getClippingY() { return _imageInfo->ClippingY; }
	inline int getClippingW() { return _imageInfo->ClippingW; }
	inline int getClippingH() { return _imageInfo->ClippingH; }
